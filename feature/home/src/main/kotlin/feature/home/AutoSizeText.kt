...
import feature.home.SuggestedFontSizesStatus.Companion.rememberSuggestedFontSizesStatus
...
private fun <E> List<E>.findElectedValue(shouldMoveBackward: (E) -> Boolean) = run {
...
internal enum class SuggestedFontSizesStatus {
...
private fun Density.toIntSize(dpSize: DpSize): IntSize = IntSize(dpSize.width.roundToPx(), dpSize.height.roundToPx())